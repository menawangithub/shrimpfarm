...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <!-- Basic Layout -->
        <form action="{{ route('saveAddDataBudidaya') }}" method="POST">
            @csrf
            <div class="row">
                <div class="col-xl">
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" name = "keterangan" id="basic-default-company keterangan" placeholder="Keterangan" value ="{{ isset($data[0]) ? $data[0]['keterangan'] : '' }}" />
                          </div>
                          ...
                          <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                placeholder="200"
                                name = "luas_kolam"
                                value ="{{ isset($data[0]) ? $data[0]['luas_kolam'] : '' }}"
                              />
                          ...
                          <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                              <input
                                ...
                                value ="{{ isset($data[0]) ? $data[0]['jumlah_ruas_kolam'] : '' }}"
                              />
                              <span class="input-group-text" id="basic-default-email2">m2</span>
                            </div>
                          </div>
